...
export const App = () => {
  ...
  const submit = () => {
    window.gtag('event', '5275_confirm_var2');
    setLoading(true);
  ...
  const openCalc = () => {
    window.gtag('event', '5275_calc_var2');
    setOpenBs(true);
  };
    ...
    <>
      <div className={appSt.container}>
        ...
        <Steps isVerticalAlign interactive={false} className={appSt.stepStyle}>
          ...
          <span>
            ...
            <Typography.Text
              ...
              color="secondary"
              onClick={() => {
                window.gtag('event', '5275_income_var2');
        ...
        <div style={{ marginTop: '1rem' }}>
          <div
            onClick={() => {
              window.gtag('event', '5275_FAQ1_var2');
        ...
        <div style={{ marginTop: '1rem' }}>
          <div
            onClick={() => {
              window.gtag('event', '5275_FAQ2_var2');
        ...
        <div style={{ marginTop: '1rem' }}>
          <div
            onClick={() => {
              window.gtag('event', '5275_FAQ3_var2');
        ...
        <div style={{ marginTop: '1rem' }}>
          <div
            onClick={() => {
              window.gtag('event', '5275_FAQ4_var2');
        ...
        <div
          onClick={() => {
            window.gtag('event', '5275_moreinfo_var2');
